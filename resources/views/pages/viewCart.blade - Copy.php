...
<div class="row border-bottom-product mb-0">
    ...
    <div class="row mb-5">
            ...
            <form method="post" action="{{route('subscribe-process')}}">
                ...
                <table class="table table-hover" id="cart-table">
                    ...
                    <tr >
                        ...
                        <td>
                            <span>
                            <button type="button" class="btn btn-icon rounded-circle btnMinus" id="btnMinus" attr="{{$k}}" single_price="{{$value['amount']}}" product_id="{{$value['id']}}"><i data-feather="minus"></i>-</button>
                            <input type="text" readonly class="form-control" style="width:50px;" value="{{$value['qty']}}"  id="num_qty<?php echo $k?>" name="num_qty" />
                            <button type="button" class="btn btn-icon rounded-circle btnPlus" id="btnPlus" attr="{{$k}}" single_price="{{$value['amount']}}" product_id="{{$value['id']}}"><i data-feather="plus"></i>+</button>
                            </span>
                        </td>
                        ...
                        <td> <a href="javascript:void(0)" class='delete-cart' product_id="{{$value['id']}}" data-attr="{{$value['id']}}" style="color: #da3340;"><i class="fa fa-trash-o" aria-hidden="true"></i></a> </td>
        ...
        <div class="col-sm-12 col-md-3 col-12 " style="background-color: #f5f5f5;">
            ...
            <div class="row">
                ...
                <div class="col-12 pt-3">
                    <h6 style="width:70%; display: inline-block; float:left">Purchase Total  </h6>
                ...
                <!-- <div class="col-6 p-0"> 
                    <a href="{{url('/')}}">
                        <button type="button" class="btn e-series-book">
                            <span class="glyphicon glyphicon-shopping-cart">Goto Shopping</span> 
                        </button>
                    </a>
                </div> -->
                <div class="col-12 pt-3">
                ...
                <div class="col-12 div">
                    <input type="text" id="mycoupon" class="ppfix post trash"  name="mycoupon" value="" style="" placeholder="Enter Coupon Code here..">
                    <span class="postfix trash" id="apply_coupon"> Apply </span>
                                       ...
                                       <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 60%;" role="document">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Product Summery</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-2"><img src="{{$value['image']}}" style="width: 100%; height: auto;  padding: 5px;"> </div>
                                                        <div class="col-md-10 text-left">  
                                                            <div class="row">
                                                                <div class="col-md-5"> Product Name </div>
                                                                <div class="col-md-1"> : </div>
                                                                <div class="col-md-4" id="product_name"></div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-5"> Product Quantity </div>
                                                                <div class="col-md-1"> : </div>
                                                                <div class="col-md-4" id="product_qty"> </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-5"> Product Price </div>
                                                                <div class="col-md-1"> : </div>
                                                                <div class="col-md-4"><strong ><span>&#8377;</span><span id="product_price"></span></strong>   </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-5"> Total Price </div>
                                                                <div class="col-md-1"> : </div>
                                                                <div class="col-md-4"><strong><span>&#8377;</span><span id="product_totalprice"></span></strong> </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
$(document).ready(function(){
    ...
    $('.delete-cart').on('click', function(){
        ...
        {
            alert("Atleast One product is must in Cart page");
            return false;
        }
       });
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    if(msg == 'true')
                    {
                       ...
                       var discount = (finalamt - ( finalamt * 10 / 100 )).toFixed(2);
                       var coupondiscount = $("#coupon_discountcharge").text(( finalamt * 10 / 100 ).toFixed(2));
                       //alert(discount);
