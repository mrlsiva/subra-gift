...
<script src="{{ url('resources/js/flipbook.min.js') }}"></script>
...
<input type="hidden" id="category" value={{$series_table_name}} />
    ...
    <img src= "https://littleprodigybooks.s3.ap-south-1.amazonaws.com/img/{{$series_table_name}}/thumb/{{$series_table_name}}.png" />
</div>
