...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit product - {{$category->series_name}}</div>
                <div class="card-body">
                    ...
                    <form action="{{route('admin.update.book')}}" method="POST" name="addbooks" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="attach" id="attach">
                                <option value="" @if($getBook->product_attach == "") {{ 'selected' }} @endif>Select</option>
                                <option value="3" @if($getBook->product_attach == 3) {{ 'selected' }} @endif>No Attachment</option>
                                <option value="1" @if($getBook->product_attach == 1) {{ 'selected' }} @endif>Image</option>
                                <option value="2" @if($getBook->product_attach == 2) {{ 'selected' }} @endif>Text</option>
                                <option value="4" @if($getBook->product_attach == 4) {{ 'selected' }} @endif>Both Image & Text</option>
