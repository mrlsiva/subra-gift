...
<?php 
//print_r($order_shipstatus);
?>
    <!--<div class="col-md-12">

        @if($order->ship_status == 1 && $order->ship_status != 5)
        ...
        @elseif($order->ship_status == 2 && $order->ship_status != 5)
        ...
        @elseif($order->ship_status == 3 && $order->ship_status != 5)
        ...
        <button type="button" class="btn btn-secondary mybutton" name="button_status" id="btn_cancelled" value="5" style="color:red;">{{ trans('app.cancelled') }}</button>
        @endif
    </div>-->
    <div class="col-md-12">
