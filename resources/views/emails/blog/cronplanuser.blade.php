        ...
        <div style="max-width: 680px; width: 100%; margin-top: 5px;">
            ...
            <div style="background-color: #fbfcfd; border-top: thick double #cccccc; text-align: left; width: 100%;">
                <div style="padding: 20px; width: 100%;">
                    <p style="width: 80%;">
                        Dear {{$data['to_name']}} Congratulations,<br> <br> You have now subscribed to an {{$data['plan']}} exclusive membership to access all our E-Books from The Little Prodigy Books .
                    </p>
                    <p style="width: 90%;background-color: #da3340;padding: 10px;color: #fff;margin: 0;"> How to read our books ?</p>
                    <p style="width: 100%;"> Please follow these simple steps below :</p>
                    <p style="text-align: left; width: 100%;">1. Goto <a href='https://littleprodigybooks.in/login' target="_blank ">Login</a> </p>
                    ...
                    <p style="text-align: left; width: 100%;">4. Kindly fill in your Basic details and click submit </p>
