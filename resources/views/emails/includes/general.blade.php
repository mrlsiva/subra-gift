      ...
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;margin-top: 6px;margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;margin-left: 20px;margin-right: 20px;" align="center">
            <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 176px;" src="https://dipdap.ae/images/logo.png" alt="" width="176" /></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
          ...
          <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;">
            ...
            <div style="margin-left: 20px;margin-right: 20px;margin-top: 24px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h1 style="margin-top: 0;margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 31px;font-family: lucida grande,lucida sans,lucida sans unicode,verdana,sans-serif;"><span class="font-lucida-grande" style="color:#43c6aa">Dear {{ $data['to_name'] }},</span></h1>                   
                </div>
            </div>

            <div style="margin-left: 20px;margin-right: 20px;margin-bottom: 24px;">
              <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                <p class="size-24" style="margin-top: 0;margin-bottom: 0;font-family: roboto,tahoma,sans-serif;font-size: 16px;line-height: 18px;"><span class="font-roboto" style="font-size: 14px; line-height: 18px;">Thank you for using DipDap. We would like to confirm that your order has been delivered.</span></p>
              </div>
            </div>
        
            <div style="margin-left: 20px;margin-right: 20px;margin-top: 24px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h3 style="margin-top: 0;margin-bottom: 20px;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 18px;font-family: lucida grande,lucida sans,lucida sans unicode,verdana,sans-serif;"><span class="font-lucida-grande" style="line-height: 18px;color:#43c6aa;font-weight: bold;">Your order summary:-</span></h3>
                </div>
            </div>
            ...
            <div style="margin: 15px 20px;">
              <table border="1" width="100%">
                  <tr>
                      ...
                      <td width="60%">#JLT1239</td>
                  </tr>
                  <tr>
                      <td width="40%">Address</td>
                      <td width="60%">#3408, Green Lakes S2, Cluster SJLT, Dubai, UAE </td>
                  </tr>
                  <tr>
                      <td width="40%">Total Bill (Before Discount)</td>
                      <td width="60%">AED 56</td>
                  </tr>
                  <tr>
                      <td width="40%">Discount Code</td>
                      <td width="60%">FIRST25</td>
                  </tr>

                  <tr>
                      <td width="40%">Discount Amount</td>
                      <td width="60%">AED 14</td>
                  </tr>
                  <tr>
                      <td width="40%">Total Amount with 5% VAT</td>
                      <td width="60%">AED 44.10</td>
                  </tr>

                  <tr>
                      <td width="40%">Total Number of clothes</td>
                      <td width="60%">14</td>
                  </tr>

                  <tr>
                      <td width="40%">Payment</td>
                      <td width="60%">Paid | Credit Card Payment link</td>
                  </tr>
              </table>
            </div>
            ...
            <div style="margin-left: 20px;margin-right: 20px;margin-top: 25px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h4 style="margin-top: 0;margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 12px;line-height: 15px;font-family: lucida grande,lucida sans,lucida sans unicode,verdana,sans-serif;"><span class="font-lucida-grande" style="font-size: 14px;line-height: 15px;">Please find attached the detailed invoice for your reference.</span></h4>
                </div>
            </div>

            <div style="margin-left: 20px;margin-right: 20px;margin-top: 20px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h3 style="margin-top: 0;margin-bottom: 20px;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 15px;font-family: lucida grande,lucida sans,lucida sans unicode,verdana,sans-serif;"><span class="font-lucida-grande" style="color:#43c6aa;line-height: 15px;">Look forward to serving you soon</span></h3>
                </div>
            </div>
      ...
      <div class="layout one-col fixed-width stack" style="margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #ffffff;"><td style="width: 600px" class="w560"><![endif]-->
          <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;">
            ...
            <div style="margin-left: 20px;margin-right: 20px;margin-top: 24px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p style="margin-top: 0;margin-bottom: 20px;font-family: lucida grande,lucida sans,lucida sans unicode,verdana,sans-serif;"><span class="font-lucida-grande">Need Help? <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #41637e;" href="https://dipdap.ae/contact-us.html">Write to us</a> or <a href="tel:+971585927959">Call us</a></span></p>
      </div>
    </div>
          ...
          <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="margin-left: 20px;margin-right: 20px;margin-top: 10px;margin-bottom: 10px;">
                ...
                <td style="padding: 0;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://www.facebook.com/DipDap-106044960942570/?ti=as"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" alt="Facebook" /></a></td><td style="padding: 0 0 0 3px;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://twitter.com/DipDap17"><img style="border: 0;" src="https://i3.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png" width="26" height="26" alt="Twitter" /></a></td><td style="padding: 0 0 0 3px;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://instagram.com/dipdaplaundry"><img style="border: 0;" src="https://i5.createsend1.com/static/eb/master/13-the-blueprint-3/images/instagram.png" width="26" height="26" alt="Instagram" /></a></td>
                </tr></tbody></table>
                <div style="font-size: 12px;line-height: 19px;margin-top: 20px;">
                  <div>DipDap<br />
                        Mother Touch Laundry LLC<br />
                        Al Barsha, Dubai, P.O. BOX 488076<br />
                        United Arab Emirates
                    </div>
                </div>
                <div style="font-size: 12px;line-height: 19px;margin-top: 18px;">
                  <div>You are receiving this email, since you are a customer of DipDap</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
